      ...
      Future<void>.delayed(Duration(seconds: 1), () {
        Future<void>.delayed(Duration(seconds: 1), () {
          Map<String, dynamic> data = {
            "data": {
              "advanceBookingFrom": doctorDetailsList
                  .data!.data![0].advanceBookingFrom
                  .toString(),
              "advanceBookingTo":
                  doctorDetailsList.data!.data![0].advanceBookingTo.toString()
            }
          };
          userPreference.saveUserDetails(data);
        });
      }).then((_) {
